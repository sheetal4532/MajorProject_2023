    ...
    <div class="container fluid">
      ...
      <form id="redirectForm" method="post" action="request.php">
        <div class="form-group">
          ...
          <input class="form-control" name="appId" value="TEST394665d0c99df0d0b5d6e7ca3a566493"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input class="form-control" name="returnUrl" value="http://localhost/SCSIT_project/cashfree/checkout/response.php"/>
        </div>        
        <div class="form-group">
