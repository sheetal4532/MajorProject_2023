...
<span><i class="fas fa-chevron-down pt-1"></i></span>
    ...
    <section class="product" id="product">
        <h1 class="heading"> All variety <span>Seeds</span></h1>
        ...
        <div class="shop-content">
            ...
            <div class="food-box">
                <div class="pic">
                    <img src="seedss/babycorn.jpeg" class="food-img">
                </div>
                <h2 class="food-title">Babycorn</h2>
            ...
            <div class="food-box">
                <div class="pic"><img src="seedss/bhindi.webp" class="food-img"></div>
                <h2 class="food-title">Bhindi</h2>
                <span class="food-price">Rs.25</span>
                <ion-icon name="cart" class="add-cart"></ion-icon>
            </div>

            <div class="food-box">
                <div class="pic"><img src="seedss/bringle.webp" class="food-img"></div>
                <h2 class="food-title">Bringle</h2>
                <span class="food-price">Rs.30</span>
                <ion-icon name="cart" class="add-cart"></ion-icon>
            </div>

            <div class="food-box">
                <div class="pic"><img src="seedss/capsicum.webp" class="food-img"></div>
                <h2 class="food-title">Capsicum</h2>
                <span class="food-price">Rs.15</span>
                <ion-icon name="cart" class="add-cart"></ion-icon>
            </div>

            <div class="food-box">
                <div class="pic"><img src="seedss/chili.webp" class="food-img"></div>
                <h2 class="food-title">Chili</h2>
                <span class="food-price">Rs.25</span>
                <ion-icon name="cart" class="add-cart"></ion-icon>
            </div>

            <div class="food-box">
                <div class="pic"><img src="seedss/coriander.webp" class="food-img"></div>
                <h2 class="food-title">Coriander</h2>
                <span class="food-price">Rs.15</span>
                <ion-icon name="cart" class="add-cart"></ion-icon>
            </div>
            ...
            <div class="food-box">
                <div class="pic"><img src="seedss/farmgokart.webp" class="food-img"></div>
                <h2 class="food-title">Farmgokart</h2>
                <span class="food-price">Rs.15</span>
                <ion-icon name="cart" class="add-cart"></ion-icon>
            </div>
            ...
            <div class="food-box">
                <div class="pic"><img src="seedss/ridge-gourd.webp" class="food-img"></div>
                <h2 class="food-title">Ridge-gourd</h2>
                <span class="food-price">Rs.20</span>
                <ion-icon name="cart" class="add-cart"></ion-icon>
            </div>

            <div class="food-box">
                <div class="pic"><img src="seedss/spinach.png" class="food-img"></div>
                <h2 class="food-title">Spinach</h2>
                <span class="food-price">Rs.20</span>
                <ion-icon name="cart" class="add-cart"></ion-icon>
            </div>

            <div class="food-box">
                <div class="pic"><img src="seedss/tomato.webp" class="food-img"></div>
            ...
            <div class="food-box">
                <div class="pic"><img src="seedss/strawberry.webp" class="food-img"></div>
